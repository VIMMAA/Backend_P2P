...
namespace BackendP2P.Migrations
{
    ...
    [Migration("20250622214510_checkpackagesolutionmodel")]
    partial class checkpackagesolutionmodel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.CheckPackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SolutionCheck", b =>
                {
                    ...
                    b.Property<Guid>("CheckPackageId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Api.Models.CheckPackage", b =>
                {
                    b.HasOne("Api.Models.TaskModel", "Task")
                        .WithOne("CheckPackage")
                        .HasForeignKey("Api.Models.CheckPackage", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolutionCheck", b =>
                {
                    ...
                    b.HasOne("Api.Models.CheckPackage", "CheckPackage")
                        .WithMany("SolutionChecks")
                        .HasForeignKey("CheckPackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
